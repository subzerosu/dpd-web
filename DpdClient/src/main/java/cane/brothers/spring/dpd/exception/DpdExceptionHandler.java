 ...
 */
@ControllerAdvice
public class DpdExceptionHandler extends ResponseEntityExceptionHandler {

	@ExceptionHandler({ DpdCalculationException.class })
    protected ResponseEntity<Object> handleInvalidRequest(Exception e, WebRequest request) {
		DpdCalculationException ire = (DpdCalculationException) e;
